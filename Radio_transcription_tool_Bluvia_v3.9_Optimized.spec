...
exe = EXE(
    ...
    a.datas,
    [],
    name='Radio_transcription_tool_Bluvia_v3.9_Optimized',
    debug=False,
    ...
    icon=os.path.join('Bluvia images', 'Bluebird app icon 2a.ico'),  # Use os.path.join for cross-platform compatibility
)
